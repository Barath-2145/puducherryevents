...
class PBCustomerListComponent extends PBCompnent {
    ...
    show() {
        this.customerList.style.display = "unset";
    }
    hide() {
    ...
    loadcustomers() {
        ...
        $(customers).each(function () {
            ...
            if (this.Flag === 1) {
                this.Status = "<div class='text-center'><i class='fa fa-thumbs-up' style='color: green;'></i> <b style='color: green;'> Accept</b>" + "</div>";
                
            } else if (this.Flag === 0) {
                this.Status = "<div class='text-center'><i class='fa fa-close' style='color: red;'></i> <b style='color: red;'> Uncheck</b>" + "</div>";
            }
        });
